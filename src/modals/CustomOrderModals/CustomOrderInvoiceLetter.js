          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.topInfo}>
                Payment Later(₹{invoice.paymentDetails.pending})
              </Text>
              ...
              {[
                {
                  label: 'Date',
                  value: invoice.invoiceDetails.date?.slice(0, 10),
                },
                {
                  label: 'Name:',
                ...
                { label: 'Purity', value: invoice.productDetails[0].purity },
                {
                  ...
                  value: invoice.productDetails[0].expectedDeliveryDate?.slice(
                    0,
                    10,
                  ),
                },
                {
                  ...
                  value: invoice.productDetails[0].expectedAmount,
                },
              ].map((item, index) => (
              ...
              <View style={styles.detailContainer}>
                ...
                <Text style={styles.totalValue}>
                  ₹{invoice.paymentDetails.totalAmount}
                </Text>
              </View>
