...
const CustomOrderLetter = ({ visible, onClose, invoice }) => {
  ...
  // Calculate total expected amount from all products
  const totalExpectedAmount = products.reduce(
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          >
            ...
            {/* Title */}
            <Text style={styles.title}>Custom Order - Payment Later</Text>
            ...
            <Text style={styles.topInfo}>
              Payment Later ({formatAmount(invoice.paymentDetails?.pending)})
            </Text>
              ...
              products.map((product, index) => (
                <View style={styles.productBox} key={index}>
                  ...
                  <View style={styles.statusContainer}>
                    <Text style={styles.statusText}>Payment Later</Text>
                  </View>
                </View>
              ))
            )}
            ...
            <View style={styles.totalContainer}>
              ...
              <Text style={styles.totalValue}>
                {formatAmount(totalExpectedAmount)}
              </Text>
            </View>
            ...
            >
              <View style={styles.invoiceBtnContent}>
                <Text style={styles.invoiceBtnText}>Generat Invoice</Text>
                <Image
...
export default CustomOrderLetter;
