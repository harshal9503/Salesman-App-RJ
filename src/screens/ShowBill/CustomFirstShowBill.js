...
const CustomFirstShowBill = ({ navigation, route }) => {
  ...
  // Helper function to get customer name - show "Cash" if null/empty, otherwise show the name
...
export default CustomFirstShowBill;